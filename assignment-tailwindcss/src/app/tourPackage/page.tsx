              ...
              <div className="p-4">
                <div className="flex justify-between mb-3 text-sm text-gray-500">
                  <small className="flex items-center">
                    <FaMapMarkerAlt className="text-teal-600 mr-1" />
                    {pkg.location}
                  </small>
                  <small className="flex items-center">
                  ...
                  <small className="flex items-center">
                    <FaUser className="text-teal-600 mr-1" />
                    {pkg.persons}
                  </small>
                </div>
                
                <a className="h5 block text-gray-900 hover:text-teal-600 font-semibold mb-2" href="#">
                  {pkg.title}
                </a>
                ...
                <div className="border-t mt-4 pt-4">
                  <div className="flex justify-between items-center">
                    <h6 className="m-0 text-sm flex items-center">
                      <FaStar className="text-teal-600 mr-1" />
